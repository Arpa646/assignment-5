function Conversation() {
  return (
    ...
    >
      {/* Left - Contact Form */}
      <div className="w-full lg:w-3/4 mx-auto flex flex-col lg:flex-row justify-between items-center">
        {/* Form Section */}
        <div
          style={{ border: "1px solid #AA8B5F" }}
          className="w-full lg:w-2/4 p-8 shadow-lg mb-8 lg:mb-0"
        >
          ...
          <form>
            ...
            <button
              ...
              className="w-full p-3 hover:bg-yellow-700 transition duration-300"
            >
              Send Your Message
            </button>
          </form>
