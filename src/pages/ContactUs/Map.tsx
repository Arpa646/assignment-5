function Conversation() {
  return (
    <div className="min-h-screen bg-black text-white p-8">
      {/* Left - Contact Form */}
      <div className="w-full lg:w-3/4 mx-auto flex flex-col lg:flex-row-reverse justify-between items-center">
        <div
          style={{ border: "1px solid #AA8B5F" }}
          className="text-center w-full lg:w-[400px] p-8 bg-black shadow-lg"
        >
        ...
        {/* Right - Image/Map */}
        <div className="w-full lg:w-1/2 p-8 h-[400px] lg:h-[600px]">
